<?php
	...
	class Register extends Request {
		public function execute () {
         ...
         $body_email = 'Dear ' . $name . '.<br>Thank you for creating an account at kindmind to activate your account just click on the link below.<br><a href="' . $this->env->url_front . 'activate?token=' . $token . '">CLICK HERE</a>';
